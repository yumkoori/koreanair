...
public class FlightSeatLoadService {
	...
	public List<FlightSeatSaveDTO> seatload( String flight_id ){
		System.out.println("서비스에서 받는 >  " + flight_id);
		ProjectDao dao = new ProjectDaoimpl();
		
        try {
            // 3. DAO의 메소드를 '호출'하고 그 결과를 받습니다. *** 이 부분이 누락되었습니다 ***
            //    이제 ProjectDaoimpl의 flightSeatload()가 실행됩니다.
            List<FlightSeatSaveDTO> seatList = dao.flightSeatload(flight_id);
