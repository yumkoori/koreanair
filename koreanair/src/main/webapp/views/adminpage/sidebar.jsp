							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> Home <span
									...
									<ul class="nav child_menu">
										<li><a href="<%= contextPath %>/views/adminpage/adminindex.jsp">Dashboard</a></li>
										<li><a href="">Dashboard2</a></li>
										<li><a href="">Dashboard3</a></li>
										<li><a href="<%= contextPath %>/views/adminpage/seatmanagement.jsp">좌석관리</a></li>
										<li><a href="<%= contextPath %>/views/adminpage/flightmanagement.jsp">비행스케줄표</a></li>
										<li><a href="<%= contextPath %>/views/adminpage/usersearch.jsp">사용자 검색 기능</a></li>
										<li><a href="<%= contextPath %>/views/adminpage/reservationManagement.jsp">예약 검색 기능</a></li>
									</ul></li>
